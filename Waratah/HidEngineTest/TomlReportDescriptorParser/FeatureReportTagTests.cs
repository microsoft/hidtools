...
namespace HidEngineTest.TomlReportDescriptorParser
{
    ...
    [TestClass]
    public class FeatureReportTagTests
    {
        [TestMethod]
        public void SimpleTagCreation()
        {
            ...
            FeatureReportTag tag = FeatureReportTag.TryParse(rawTomlTags.ElementAt(0));
        ...
        public void InvalidSectionName()
        {
            ...
            Assert.IsNull(FeatureReportTag.TryParse(rawTomlTags.ElementAt(0)));
        }
    }
}
