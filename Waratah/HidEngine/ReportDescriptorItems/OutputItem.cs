...
namespace HidEngine.ReportDescriptorItems
{
    ...
    /// <summary>
    /// Defines a Output MainData item.
    /// </summary>
    [MainItem(HidConstants.MainItemKind.Output)]
    public class OutputItem : ShortItem
    {
        ...
        static OutputItem()
        {
            IEnumerable<PropertyInfo> properties = typeof(OutputItem).GetProperties();
